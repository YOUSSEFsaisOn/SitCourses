...
const footerLinks = {
  ...
  community: [
    { name: "Teach on LearnHub", href: "/teach" },
    ...
    <footer className="bg-card border-t border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">© 2025 LearnHub, Inc. All rights reserved.</p>
          <div className="flex items-center gap-4">
            <select className="bg-secondary text-foreground text-sm rounded-lg px-3 py-2 border border-border">
